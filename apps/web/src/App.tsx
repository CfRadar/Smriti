      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
          <div style={{
            ...
            <h3 style={{ fontSize: '1.1rem', fontWeight: 600, marginBottom: '0.5rem' }}>Caregiver Hub</h3>
            <p style={{ fontSize: '0.875rem', color: '#94a3b8' }}>Patient daily tracking, reminders, and memory uploads.</p>
          </div>
          <div style={{
            background: 'rgba(15, 23, 42, 0.6)',
            padding: '1.5rem',
